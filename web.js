...
;
	...
	($mol_mem(($.$bog_wysiwyg_menu.prototype), "handle_key"));
...
;
	($.$bog_wysiwyg) = class $bog_wysiwyg extends ($.$mol_view) {
		...
		Menu(){
			...
			(obj.handle_key) = (next) => ((this.menu_handle_key(next)));
	...
	($mol_mem(($.$bog_wysiwyg.prototype), "menu_handle_key"));
